...
matrix3 = Matrix([[1,4,4,4],[2,3,5,4],[4,5,6,4],[2,3,4,4]])
matrix4=Matrix([[-8.0, 8.0, 0.0, -2.0], [-8.0, -8.0, 16.0, -6.0], [4.0, 4.0, 0.0, -5.0], [12.0, -4.0, -16.0, 17.0]])
print(matrix4.matrix_inverse())
